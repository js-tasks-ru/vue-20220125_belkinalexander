<template>
  <form class="meetup-form" @submit.prevent="onClickSubmit">
    <div class="meetup-form__content">
      ...
      <meetup-agenda-item-form
        ...
        @remove="removeMeetupAgendaItem(index)"
        @update:agendaItem="updateMeetupAgendaItem(index, $event)"
      />
    ...
    <div class="meetup-form__aside">
      <div class="meetup-form__aside-stick">
        ...
        <ui-button variant="secondary" block class="meetup-form__aside-button" data-test="cancel" @click="onClickCancel">Отмена</ui-button>
...
export default {
  ...
  methods: {
    removeMeetupAgendaItem(index) {
      this.localMeetup.agenda.splice(index, 1);
    },
    updateMeetupAgendaItem(index, agendaItem) {
      this.localMeetup.agenda[index] = agendaItem;
    },
    onClickMeetupFormAppend() {
